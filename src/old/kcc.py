...
class PandaBulletCharacterController(object):
    ...
    def __init__(self, world, parent, walkHeight, crouchHeight, stepHeight, radius, gravity=None):
        ...
        self.char.setScale(.75)
        self.char.setH(180)
        # self.char.setPos(0, 1, -5)
        self.char.setBlend(frameBlend = True) 
        self.char.loop('idle')
    ...
    def startJump(self, maxHeight=1.5):
        """
    ...
    def __land(self):
        self.movementState = "ground"
        self.isIdle = False
        self.char.setPlayRate(1.0, 'land')
        self.char.play('land')
    ...
    def __fall(self):
        ...
        self.isIdle = False
        self.char.setPlayRate(1.0, "fall")
        self.char.play('walk')
    ...
    def __jump(self, maxZ = 3.0):
        ...
        # if self.movementState == "jumping" and inputState.isSet('left'): 
        #     self.isIdle = False
        #     self.char.setR(self.movementParent, -90)
...
########anim
        self.isIdle = False
        self.char.setPlayRate(1.0, "jump")
        self.char.play('jump')
        # self.char.setH(self.movementParent, 180)
...
######walk states
        ...
        if inputState.isSet('left'): 
            self.isIdle = False
            self.char.setH(self.movementParent, -90)
            self.char.setPlayRate(1.0, "walk")
            if(anim!="walk"):
                self.char.loop("walk")  
        ...
        if inputState.isSet('right') and inputState.isSet('forward'): 
            self.isIdle = False
            self.char.setH(self.movementParent, 135)
            self.char.setPlayRate(1.0, "walk")
            if(anim!="walk"):
                self.char.loop("walk")        
        ...
        if inputState.isSet('reverse') : 
            self.isIdle = False
            self.char.setH(self.movementParent, 0)
            self.char.setPlayRate(1.0, "walk")
            if(anim!="walk"):
                self.char.loop("walk")
        ...
        if inputState.isSet('right') and inputState.isSet('reverse'): 
            self.isIdle = False
            self.char.setH(self.movementParent, 45)
            self.char.setPlayRate(1.0, "walk")
            if(anim!="walk"):
                self.char.loop("walk")        
    ...
    def __processFalling(self):
        ...
        ###anim
        self.char.setPlayRate(2.0, 'falling')
        self.char.play('falling')
